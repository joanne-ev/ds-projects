...
def _(data, pl, stadium_latitude, stadium_longitude, stadium_region):
    data_new = (
        ...
        .cast({
            "Round Number": pl.UInt8, "Day": pl.UInt8, "Month": pl.UInt8, "Year": pl.UInt16, "Hour": pl.UInt8, 
            "Longitude": pl.Decimal(scale=3), "Latitude": pl.Decimal(scale=3), 
            "Home Goals": pl.UInt8, "Away Goals": pl.UInt8, "Goals Scored": pl.UInt8
        })
    )
    return (data_new,)
...
def _(data_new, pl):
    ...
    data_new_1 = data_new.cast({'Kickoff': kickoff_enum})
    return (data_new_1,)
